{
  ...
  scroll_music_status =
    writeShellScript "scroll_music_status"
    /*
    bash
    */
    ''
  ...
  bluetooth_toggle =
    writeShellScript "bluetooth_toggle"
    /*
    bash
    */
    ''
  ...
  bluetooth_status =
    writeShellScript "bluetooth_status"
    /*
    bash
    */
    ''
